        ...
        try {
            ...
            if (cmd == 'help' || cmd == 'menu') {
                ...
                const buttonsDefault = [
                    { urlButton: { displayText: `github`, url: `https://github.com/Ilhamskhyzi` } },
                    { callButton: { displayText: ``, phonenumber: `087773710155` } },
                    { quickReplyButton: { displayText: ` Owner`, id: `${prefix}developer` } },
                ]
            ...
            if (/owner/.test(cmd)) {
                ...
                await delay(2000)
                const btn = [
                    { urlButton: { displayText: `Web`, url: `https://www.skhyzi.id` } },
                    { urlButton: { displayText: `team-catzy`, url: `https://chat.whatsapp.com/Hw1iYmAq8Cp2Ju64T7el09` } },
                    { urlButton: { displayText: `Github`, url: `https://github.com/Ilhamskhyzi` } },
